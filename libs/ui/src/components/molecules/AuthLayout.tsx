'use client'
import { RotatingCamera } from '@parking-management-microservice/3d/src/components/camera/RotatingCamera'
import { CarScene } from '@parking-management-microservice/3d/src/scenes/CarScene'
